                    ...
                    <td>
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="{{route('admin.former-judge.edit',$stationJudge)}}">Edit</a></li>
                                <li>
                                    <form action="{{ route('admin.former-judge.destroy', $stationJudge) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this record?')">
                                        @csrf
                                        @method('DELETE')
