        ...
        <div class="card-body">
            <form action="{{ route('admin.station-judge.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="parent_court" value="{{ old('parent_court') }}" rrr>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="stream" value="{{ old('stream') }}" rrr>
                    <span class="text-danger small">@error('stream') {{ $message }} @enderror</span>
                </div>
                <div class="mb-3">
                    <label class="form-label">Elevation Date *</label>
                    <input type="text" class="form-control datepicker" name="elevation_date" value="{{ old('elevation_date') }}" rrr>
                    <span class="text-danger small">@error('elevation_date') {{ $message }} @enderror</span>
                </div>
                <div class="mb-3">
                    <label class="form-label">Stationing *</label>
                    <input type="text" class="form-control" name="stationing" value="{{ old('stationing') }}" rrr>
