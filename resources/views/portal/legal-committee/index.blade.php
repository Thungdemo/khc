...
<div class="container site-main">
  <div class="mb-4">
    ...
    <p class="hc-text-muted mb-0">Legal Committee Members of Gauhati High Court Kohima Bench</p>
  </div>
    ...
    <div class="col">
      <div class="card-wrap h-100">
        ...
        <div class="mt-4 text-center">
          <h5 class="fw-semibold mb-2" style="font-size: 1rem;">{{ $legalCommittee->full_name }}</h5>
          <p class="hc-text-muted small">
